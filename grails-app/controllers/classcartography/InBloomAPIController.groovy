...
class InBloomAPIController {
    ...
    def auth () {
    	...
    	def fullurl = "http://api.sandbox.inbloom.org/api/oauth/authorize?client_id=UzMIy7jMGB&response_type=code&redirect_uri=http://localhost:8080/classcartography/login"
